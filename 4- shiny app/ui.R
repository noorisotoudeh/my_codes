...
### Page title 
titlePanel("Pieper Lab Data Analysis"),  
navbarPage( 
  NULL,  
 ...
 #   h4("CoAccsession of two genes on reduced dimensions"), 
 #   "In this tab, users can visualise the coAccsession of two genes ", 
 #   "on low-dimensional representions.", 
 #   br(),br(), 
 #   fluidRow( 
 #     column( 
    ...
    fluidRow(
      column(
        ...
        selectInput("sc1d1grp", "Group by:",
                    ...
                    selected = sc1conf[grp == TRUE]$UI[2]) %>%
          helper(type = "inline", size = "m", fade = TRUE,
                 title = "Cell information to group cells by",
                 content = c("Select categorical cell information to group cells by",
                             "- Single cells are grouped by this categorical covariate",
...
tabPanel(
  ...
  fluidRow(
    ...
    fluidRow(column(6, plotOutput("sc2de1oup"))    ),  # End of column (6 space),
    fluidRow( column(6,
...
br(), 
# p(strong("Reference: "),"Data Analysis ",style = "font-size: 125%;"), 
